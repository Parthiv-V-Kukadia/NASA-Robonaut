...
%
%   MakeRoad(filename, 'display', false) turns off the interactive plotting
%       and suppresses all output to the command window.
%

% Parse the arguments
p = inputParser;
p.PartialMatching = false;
addOptional(p, 'filename', 'road.mat', @ischar);
